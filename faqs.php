	...
	<div class="nav">	
		...
		<div id="content">
			<legend>Frequently Added Questions</legend>
				 ...
				 <h4>DO YOU SHIP?</h4>
					<p style="text-indent:60px;">Yes, we ship the products via Pos Laju and J&T.</p>
				<hr>
					<h4>DO YOU DELIVER?</h4>
						<p style="text-indent:60px;">No, We only offer Shipping.</p>
				<hr>
					<h4>WHEN WILL I GET MY ORDERS?</h4>
						<p style="text-indent:60px;">We wil ship your product 2-3 days around but the guaranteed time maybe suspended depending on the weather conditions or courrier management.</p>
				<hr>
